@REM travelogueservice launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM TRAVELOGUESERVICE_config.txt found in the TRAVELOGUESERVICE_HOME.
@setlocal enabledelayedexpansion

@echo off

if "%TRAVELOGUESERVICE_HOME%"=="" set "TRAVELOGUESERVICE_HOME=%~dp0\\.."

set "APP_LIB_DIR=%TRAVELOGUESERVICE_HOME%\lib\"
...
set "CFG_FILE=%TRAVELOGUESERVICE_HOME%\TRAVELOGUESERVICE_config.txt"
set CFG_OPTS=
if exist "%CFG_FILE%" (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running travelogueservice.
  echo.
...
"%_JAVACMD%" !_JAVA_OPTS! !TRAVELOGUESERVICE_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
